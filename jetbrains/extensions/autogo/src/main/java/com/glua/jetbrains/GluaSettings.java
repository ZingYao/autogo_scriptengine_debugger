...
public final class GluaSettings implements PersistentStateComponent<GluaSettings.StateData> {
    public static final class StateData {
        ...
        public int dapPort = 38697;
        public boolean useRemoteDap = true;
    ...
    public int dapPort() {
        return state.dapPort >= 1 && state.dapPort <= 65535 ? state.dapPort : 38697;
    }

    public void setDapPort(int dapPort) {
        state.dapPort = dapPort >= 1 && dapPort <= 65535 ? dapPort : 38697;
    }
